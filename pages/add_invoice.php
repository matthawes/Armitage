    ...
    <main id="main">
        <section id="services">
            <div class="container">
                ...
                <form method="post" action="add_invoice.php" onsubmit="if (parseFloat(document.getElementById('amountDue').value) + parseFloat(document.getElementById('amount1').value) + parseFloat(document.getElementById('amount2').value) + parseFloat(document.getElementById('amount3').value) == 'NaN') {alert(0); return false;}; else if (parseFloat(document.getElementById('amountDue').value) != parseFloat(document.getElementById('amount1').value) + parseFloat(document.getElementById('amount2').value) + parseFloat(document.getElementById('amount3').value)) {alert(1); return false;};">
                    <fieldset>
